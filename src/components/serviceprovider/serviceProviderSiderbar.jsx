...
export const ServiceProviderSiderbar = () => {
    return (
        <aside
        ...
        >
          <div className="sidenav-header">
            ...
            >
              <img
                ...
                alt="main_logo"
              />
              <span className="ms-1 font-weight-bold">Service provider Dashboard</span>
            </Link>
          </div>
          ...
          >
            <ul className="navbar-nav">
              ...
              <li className="nav-item">
                <Link className="nav-link " to="/serviceprovider/addservice">
                  <div className="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    <i className="ni ni-calendar-grid-58 text-warning text-sm opacity-10" />
                  </div>
                  <span className="nav-link-text ms-1">Add service</span>
                </Link>
              </li>
              <li className="nav-item">
